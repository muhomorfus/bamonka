  ...
  <main class="container">
    ...
    <div class="row">
      ...
      <div class="col-md-8">
        ...
        <div class="card mb-3">
          <div class="card-body">
            <h1>Editing «{{ employer.name }}»</h1>

            <form @submit.prevent="saveEmployer">
              <div v-if="isAdmin || isHR" class="mb-3">
              ...
              <div class="mb-3">
                ...
                <textarea required class="form-control" id="description" rows="3" v-model="employer.description"></textarea>
              </div>

              <div v-if="isAdmin || isHR" class="mb-3">
                <label for="department" class="form-label">Department</label>
                <select required class="form-select" id="department" aria-label="Select parent department" v-model="employer.department.id">
              ...
              <p v-if="isAdmin || isHR" class="mb-2">Teams</p>
              <div v-if="isAdmin || isHR" class="card mb-3">
                <div class="card-body">
...
export default defineComponent({
  ...
  methods: {
    ...mapActions(['loadEmployer', 'loadDepartments', 'loadTeams', 'loadEmployee', 'saveEmployer', 'addEmptyTeam', 'deleteTeamEntry']),
  },
  computed: {
    ...mapGetters(['employer', 'departments', 'teams', 'employee', 'isHR', 'isAdmin']),
  },
  created() {
    this.loadEmployer(this.$route.params.nickname.toString())
