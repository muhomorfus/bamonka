...
valgrind --quiet --leak-check=full --errors-for-leak-kinds=all --error-exitcode=$valgrind_code --log-file=../out/memcheck_neg.log ../app.exe $args <"${test_input}" >"${program_output}"
rc=$?
